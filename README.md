# Unity Project For Mobile Augmented Reality In Human Anatomy (￣▽￣)ノ
...
Visit the [other repository](https://github.com/HairyBlue/body-track-project){:target="_blank"} to run the services\
...
On Mac, ( ･ั﹏･ั)
[visit this site](https://www.wikihow.com/Find-Your-IP-Address-on-a-Mac){:target="_blank"}

On Linux, (੭•̀ᴗ•̀)੭✧ ヽ( ´ ∇ ｀ )ノ  (╯°□°)╯︵ ┻━┻

## Additional Resourcess (✧ω✧)
#### Youtube
[Find your computer ip address | how to | Windows 10 | 2021](https://www.youtube.com/watch?v=mdp3HtO7Cjs){:target="_blank"}
[How to Find IP Address on Windows 11 & Windows 10, Easiest Method to view IP Address on Windows PC](https://www.youtube.com/watch?v=_FHuWzC8BKE){:target="_blank"}
[How to Show IP ADDRESS on Apple Mac](https://www.youtube.com/watch?v=IZE548Dp4HA){:target="_blank"}